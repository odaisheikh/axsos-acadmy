...
private final BookService bookservice;
	...
	//render song
    @RequestMapping("/lookify/find/{name}")
    public String show(Model model,@PathVariable("name") String name) {
        List<BookB> song = bookservice.findlookify(name);
  ...
  //top songs
    ...
    public String top(Model model) {
    	List<BookB> songs = bookservice.topSong();
