...
public class BookService {
 ...
 // creates a book
    ...
    //find song
    public List<BookB> findlookify(String b) {
        return bookRepository.findByName(b);
    }
    // retrieves a book
...
//    	bookRepository.delete(book);
    ...
    //top song
    public List<BookB> topSong() {
        return bookRepository.findTop5BookBByOrderByRatingDesc();
    }
}
